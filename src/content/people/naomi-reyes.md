...
don't: the compliment that could apply to any outlet, the ask with no
shape, the follow-up that repeats the first email instead of adding
anything to it.

Marks from the reader's side of the desk. An email that would get replied
to at Fieldnote passes; one that would get filed under "maybe later" and
never opened again does not, regardless of how well it reads on its own.
